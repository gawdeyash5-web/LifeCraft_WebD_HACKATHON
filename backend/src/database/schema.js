...
// Authoritative PostgreSQL schema and idempotent seeds for LIFECRAFT
...
CREATE TABLE IF NOT EXISTS quests (
    ...
    realm_target VARCHAR(30) DEFAULT NULL,
    expansion_reward VARCHAR(50) DEFAULT NULL,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
